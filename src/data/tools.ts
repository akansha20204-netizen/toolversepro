...
export const TOOLS: ToolMeta[] = [
  ...
  { slug: "youtube-video-downloader", name: "YouTube Video Downloader", category: "media", description: "Download YouTube videos and Shorts in your preferred quality.", icon: "Youtube", keywords: ["youtube downloader", "youtube video downloader", "youtube shorts downloader", "download youtube video", "yt downloader", "youtube to mp4", "youtube to mp3"], featured: true, popular: true, trending: true, latest: true },
