...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "70+ free online tools that run in your browser. Calculators, image editors, PDF utilities, developer helpers, unit converters and text tools — no signup, no upload, no watermark." },
      ...
      { property: "og:description", content: "Fast, private and beautifully designed online tools for creators, students and developers." },
